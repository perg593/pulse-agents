...
class PageElementClickedTrigger < Trigger
  validates :render_after_element_clicked_enabled, exclusion: [nil]
  validates_presence_of :render_after_element_clicked

  def summarize
    return unless render_after_element_clicked_enabled

    "Element '#{render_after_element_clicked}' was clicked"
  end
end
