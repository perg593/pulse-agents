...
class MobileInstallTrigger < Trigger
  validates :mobile_days_installed, presence: true

  def summarize
    "Mobile app must have been installed for at least #{mobile_days_installed} days"
  end
end
