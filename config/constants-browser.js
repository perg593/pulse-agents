 ...
 * @fileoverview Constants used in browser environment for pulse widgets
 */
 ...
 * @type {Object}
 */
export const BEHAVIOR_LISTENER_DEFAULTS = {
  'exit-intent': false,
  'scroll-depth': true,
  'time-delay': false,
  'rage-click': false
 ...
 * @type {string}
 */
export const DEFAULT_BEHAVIOR_MESSAGE = 'Perform a behavior in the stage or click a button to simulate it.';
...
/**
 * Path constants for browser environment
 * @type {Object}
 */
